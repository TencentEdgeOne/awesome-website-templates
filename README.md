...
<table>
    ...
    <td width=700><div>
      ...
      <div><em>A beautiful room built using web 3D technology. The project is very interesting and can be used as a perfect demo to showcase web 3D technology.</em><div> <br/>
      <div>
        <a href="https://edgeone.ai/pages/new?from=awesome&template=https://github.com/brunosimon/my-room-in-3d&project-name=3droom&repository-name=3droom&install-command=npm%20update%20%26%26%20npm%20run%20build" target="_blank" style="text-decoration: none;">🚀 Deploy Now</a>
      <div> <br/></td>
  </tr>
</table>  
<table>
    ...
    <td width=700><div>
      ...
      <div><em>A 3D blog project implemented using Three.js, where users can drive a small car to find and read articles.</em><div> <br/>
      <div>
        <a href="https://edgeone.ai/pages/new?from=awesome&template=https://github.com/brunosimon/folio-2019&output-directory=dist&install-command=npm%20install&build-command=npm%20run%20build" target="_blank" style="text-decoration: none;">🚀 Deploy Now</a>
      <div> <br/></td>
  </tr>
</table>  
<table>
